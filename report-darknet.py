...
# optionally passing a value to use in the query to specify the number of days to go back
...
scanners_ours = config['scanners_ours']
...
#    cur.execute(query)
#    rows = cur.fetchall()
#    with open('/opt/hector/app/reports/report-darknet-recent.csv', 'w') as f:
